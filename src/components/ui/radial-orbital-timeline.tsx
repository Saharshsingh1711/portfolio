              ...
              >
                <div
                  className={`absolute rounded-full -inset-1 ${
                    isPulsing ? "animate-[pulse_1s_ease-in-out_infinite]" : ""
                  }`}
                  style={{
                  ...
                  <Card className="absolute top-20 left-1/2 -translate-x-1/2 w-64 bg-black/90 backdrop-blur-lg border-white/30 shadow-xl shadow-white/10 overflow-visible">
                    ...
                    <CardHeader className="pb-2">
                      <div className="flex justify-between items-center">
                        <Badge
                          className={`px-2 py-1 text-xs border-0 ${getStatusStyles(
                            item.status
                          )}`}
                        >
                            ...
                            {item.relatedIds.map((relatedId) => {
                              ...
                              return (
                                <Button
                                  ...
                                  variant="outline"
                                  size="sm"
                                  className="flex items-center h-6 px-2 py-0 text-xs rounded-full border-white/20 bg-white/5 hover:bg-white/20 text-white hover:text-white transition-all shadow-none"
                                  onClick={(e) => {
                                    e.stopPropagation();
